...
@section("title","Import Companies by Excel")
...
<div class="container">
    ...
    <ul>
        ...
        <li>Format Row: Row 1 is Name, Row 2 is Email, Row 3 is Website</li>
    </ul>
    <p><strong>Note:</strong> For the logo, I haven’t been able to do it in this process. I’m sorry about this.</p>
</div>
...
@endif
<div class="container mt-3">
    <form enctype="multipart/form-data" method="POST" action="{{route('import_companies.store')}}">
        @csrf
        <div class="mb-3">
